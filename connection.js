(function () {
	...
	commonFirebaseRef.child("chat").on("child_added", function(snapshot){
	...
	var insertMsgOnFirebase = function (stringMessage){
		...
		var newMessageRef = commonFirebaseRef.child('chat/'+actualMsgNumber).set({ "text": stringMessage, "user": "Rodrigo" });
	}
  	return firebaseJS = {
